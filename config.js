...
module.exports = {
  VERSION: 'v4.4.6',
  SESSION_ID: process.env.SESSION_ID || 'HP_2026_FEB_10_Q27P9R',
  ...
  BOT_NAME: process.env.BOT_NAME || 'Tsepi Mohlomi ',
  ...
  STICKER_DATA: process.env.STICKER_DATA || 'Tsepo Mohlomi (Osiris) ',
